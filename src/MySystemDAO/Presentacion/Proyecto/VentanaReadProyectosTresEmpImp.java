...
public class VentanaReadProyectosTresEmpImp extends VentanaReadProyectosTresEmp{
	...
	public Component initGUI() {
		...
		Contexto context = new Contexto(EventoGUI.COMANDO_READ_PROYECTOS_TRES_EMPLEADOS,
				null);
